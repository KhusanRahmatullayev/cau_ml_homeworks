...
Original file is located at
    https://colab.research.google.com/drive/1HO2nPuIYQxgVcj3LwPOoQ0aglY3Maimb
"""
...
class KNearestNeighbor:
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            dists[i, :] = np.sqrt(np.sum(
                np.square((self.X_train - X[i, :])), axis=1))
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
    ...
    def compute_distances_no_loops(self, X):
        ...
        dists = np.sqrt(np.sum(X ** 2, axis=1).reshape(-1, 1) -
                        2 * np.dot(X, self.X_train.T) + np.sum(self.X_train ** 2, axis=1))
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
